  ...
  return (
    <div className="flex flex-col justify-center items-center text-center min-h-screen bg-gray-100 px-4">
      ...
      <div className="flex gap-4">
        <a href="/register" className="bg-blue-900 text-white px-6 py-3 rounded hover:bg-blue-800 transition">
          Get Started
        </a>
        <a href="/login" className="bg-white border border-blue-900 text-blue-900 px-6 py-3 rounded hover:bg-blue-900 hover:text-white transition">
          Login
        </a>
      </div>
    </div>
